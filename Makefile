...
build-kernel:
	RUSTC_BOOTSTRAP=1 cargo build --manifest-path=tezos/etherlink/kernel_calypso/Cargo.toml \
	...
	wasm-strip -o $(BIN_DIR)/$(PACKAGE).wasm $(TARGET_DIR)/wasm32-unknown-unknown/release/evm_kernel_calypso.wasm
